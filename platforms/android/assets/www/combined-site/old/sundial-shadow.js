...
sundialShadowpackage.reRender3= function(az, el) {
	...
	console.log("light x="+ this.light.position.x+", y="+ this.light.position.y+", z="+ this.light.position.z);
...
sundialShadowpackage.doAz= function() {
...
sundialShadowpackage.createWorld= function() {
	...
	if(false) {
		...
		loader.load('./img/sundial4.jpg', function(texture) {
			...
			this.plane.receiveShadow = true;
			//earth.overdraw = true;
			this.plane.rotation.x =  Math.PI* 1.5;//-Math.PI / 2;
			
			sundialShadowpackage.scene.add(this.plane);
		});
	}
...
sundialShadowpackage.rotate= function() {
	...
	this.star.position.x+= 300;
	this.star.position.z-= 100;
	this.star.position.y+= 30;
