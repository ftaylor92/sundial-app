...
sundialShadowpackage.reRender3= function(place) {
	...
	*/
	...
	this.light.position.x = cartesian.x;
	this.light.position.y = cartesian.y;
	this.light.position.z = cartesian.z;
...
sundialShadowpackage.rotate= function() {
	...
	this.camera.position.x= -130.521711; //583.0;
	this.camera.position.y= 1080; //1028.0;
	this.camera.position.z= -991.44545; //-812.0;

	this.star.position.x= 3; //13;//0;
	this.star.position.y= 88;//59;
	this.star.position.z= -154; //-200;
	this.star.rotation.set(0, Math.PI * 1.5, 0);
